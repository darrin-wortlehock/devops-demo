...
resource "template_file" "chef-server-userdata" {
  ...
  vars {
    ...
    chef_user_name = "${var.chef_server_user_name}"
    chef_user_full_name = "${var.chef_server_user_full_name}"
    chef_user_email = "${var.chef_server_user_email}"
    chef_user_password = "${var.chef_server_user_password}"
